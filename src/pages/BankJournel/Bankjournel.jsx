          ...
          <div className="mx-auto  w-full overflow-hidden">
            <div className="shadow  bg-gray-50 overflow-hidden sm:rounded-md">
              <div className="px-4  bg-blue-100 sm:p-6">
                <div className="ml-14 grid grid-cols-10 gap-1">
                  ...
                  <div className="col-span-6 sm:col-span-6 lg:col-span-2">
                    ...
                    >
                      <optgroup>
                        ...
                        <option value="Other Expense">Dumka</option>
                        <option value="Other Income">Gaya</option>
                        <option value="Loan">Sultanganj</option>
                        <option value="Loan Habib">Jamalpur</option>
                        <option value="Loan Alheena">Deoghar</option>
                      </optgroup>
                    </select>
                  </div>
                  <div className="col-span-6 sm:col-span-6 lg:col-span-2">
                ...
                <button
                  // onClick={addMjdoor}
                  className="inline-flex justify-center px-2 pt-1 border border-transparent shadow-sm text-lg font-bold rounded-md text-white bg-gray-600 hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 "
                >
                  <svg
