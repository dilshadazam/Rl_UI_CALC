...
// import WorkAssignUpdate from "./workassign/WorkAssignUpdate";
// import { Dialog, Transition } from "@headlessui/react";
// import { ExclamationIcon } from "@heroicons/react/outline";
// const ListWorkAssign = () => {
...
//             <h1 className="mx-auto font-sans flex justify-between px-2 uppercase text-white text-2xl font-semibold">
...
//           placeholder="Search....."
//           className="text-center rounded-md text-sm text-black flex justify-end mr-2 w-full "
//           style={{
  ...
  return (
    <Main>
      <div>
        <section className=" mx-auto  w-full">
          <div className=" bg-gray-700 rounded-md shadow-2xl shadow-green-600 py-1 mb-1">
            <h1 className="flex justify-between mx-auto font-sans px-2 uppercase text-white text-2xl font-semibold">
